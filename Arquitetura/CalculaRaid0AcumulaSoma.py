def calculate_raid0_storage():
    ...
    # Calcula a capacidade total de armazenamento em RAID 0
    total_capacity = sum_capacity / num_disks

    # Imprime a capacidade total de armazenamento em RAID 0
    print(f"A capacidade total de armazenamento em RAID 0 é {total_capacity}TB.")
